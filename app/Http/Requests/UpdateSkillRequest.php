...
class UpdateSkillRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'category' => 'sometimes|required|in:technical,soft,tool',
    ...
    public function messages(): array
    {
        return [
            ...
            'category.in' => 'La categoría debe ser: technical, soft o tool',

            'proficiency.integer' => 'El nivel de competencia debe ser un entero',
            ...
            'featured.boolean' => 'El campo debe ser verdadero o falso',
