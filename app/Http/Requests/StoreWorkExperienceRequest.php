...
class StoreWorkExperienceRequest extends FormRequest
{
    ...
    public function messages():array
    {
        return [
            ...
            'responsabilities.array' => 'Las responsabildades deben ser un array.',
            'responsabilities.*.string' => 'Cada responsabilidad debe ser una cadena de texto.',

            'reference_phone.max' => 'El teléfono de referencia no puede tener mas de 20 caracteres',

            'order.integer' => 'El orden ddebe ser un número entero',
